        ...
        <div class="card-body">
            <div class="row g-3 ">
                <div class="input-group mb-3 g-3 ">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"><a class="nav-link"  href="/opens"> <i class="fa-solid fa-eye"></i> </a> </button>
                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"><a class="nav-link"  href="/edits"> <i class="fa-solid fa-pen"></i> </a> </button>
                </div>
                <div class="input-group mb-3 g-3 ">

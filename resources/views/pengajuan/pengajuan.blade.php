        ...
        <div class="card-body">
            <div class="row g-3 ">
                <div class="input-group mb-3 g-3 ">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"><a class="nav-link"  href="/open"> <i class="fa-solid fa-folder-open"></i> </a> </button>
                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"><a class="nav-link"  href="/editp"> <i class="fa-solid fa-pen"></i> </a> </button>
                </div>
                <div class="input-group mb-3 g-3 ">
